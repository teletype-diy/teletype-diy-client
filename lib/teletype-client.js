...
class TeletypeClient {
  constructor ({restGateway, pubSubGateway, connectionTimeout, tetherDisconnectWindow, testEpoch, signalURL, pusherOptions, baseURL, didCreateOrJoinPortal}) {
    this.restGateway = restGateway || new RestGateway({baseURL: baseURL, signalURL: signalURL})
    this.pubSubGateway = pubSubGateway || new PusherPubSubGateway({signalURL: signalURL, options: pusherOptions})
    this.signalURL = signalURL
    this.connectionTimeout = connectionTimeout || 120000
